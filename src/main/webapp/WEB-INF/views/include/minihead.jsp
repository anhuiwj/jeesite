...
<meta name="author" content="http://www.wondersgroup.com"/>
<script type="text/javascript" src="${ctxStatic}/jquery/jquery-1.6.2.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/miniui/miniui.js" ></script>
<script type="text/javascript" src="${ctxStatic}/miniui/jquery.tmpl.js" ></script>
<script type="text/javascript" src="${ctxStatic}/miniui/locale/zh_CN.js"></script>
<script type="text/javascript" src="${ctxStatic}/js/val.js?v=${version}"></script>
<script type="text/javascript" src="${ctxStatic}/js/disabled.backspace.js"></script>
