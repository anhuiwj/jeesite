...
<body>
    	...
    	<fieldset style="border:solid 1px #aaa;padding:3px;">
    		...
    		<table>
    			<tr>
               		...
               		<td style="width:20%;">    
                   		<input id="name" name="name" class="mini-textbox" required="true" value="${role.name }"/>
               		</td>
               		<td style="width:10%;">英文名：</td>
               		<td style="width:30%;">    
                   		<input id="enname" name="enname" class="mini-textbox" required="true" value="${role.enname }"/>
               		</td>
               		<c:if test="${fns:getUser().admin}"><!-- 判断是否超级管理员-->
               		<td style="width:10%;">机构：</td>
               		<td style="width:30%;">    
                   		<div id="orgCode" name="orgCode" value="${role.office.code }" class="mini-treeselect" resultAsTree="false" style="width:260px;" data="${fns:getOfficeTreeForAdmin('1')}" ></div>
               		</td>
               		</c:if>
       			</tr>
       ...
       <div class="mini-panel" title="资源权限" style="width:100%;height:80%;overflow:auto">
       		...
       		<ul id="resTree" class="mini-tree" url="${ctx}/sys/role/menuTree?roleId=${role.id }" checkRecursive="true"
